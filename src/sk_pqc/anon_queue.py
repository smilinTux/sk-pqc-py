...
unidirectional message queue composes on top of. It is the
...
PROVENANCE
    ...
    original implementation). Nothing here is derived from, copied from, or a
    translation of any third-party source. Only the *protocol idea* is
