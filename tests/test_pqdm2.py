...
Byte-for-byte twin of ``skcomms/tests/test_pqdm2.py`` and the Dart
``sk-pqc-dart`` codec. See the multi-device-dm-fanout design spec section 4.
"""
...
def test_slot_strip_is_rejected():
    ...
    tampered = _remove_slot_and_kid(tok, b_pub[:16])
